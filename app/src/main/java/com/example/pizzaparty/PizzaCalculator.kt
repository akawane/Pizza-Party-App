...
/**
 * PizzaCalculator: for calculating the number of pizzas required
 * @property partySize  No.of people to be considered for pizza
 * @property hungerLevel hungry level of person
 */
