...
/**
 * MainActivity for taking inputs from user and displaying output for home screen.
 */
class MainActivity : AppCompatActivity() {
    ...
    /**
     * PizzaCalculator object is called when the user clicks the calculate button to estimate the
     * total number of pizzas, returning the number of pizzas needed.
     */
